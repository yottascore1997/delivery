            ...
            {subs.length === 0 ? (
              ...
              <div className="scrollbar-hide relative z-[1] mt-6 flex gap-3 overflow-x-auto pb-1.5 pt-0.5 [-webkit-overflow-scrolling:touch]">
                ...
                return (
                  <div
                    key={sub.id}
                    className="group/card relative w-[122px] shrink-0 sm:w-[132px]"
                  >
                    <div
                    ...
                    >
                      ...
                      <div className="space-y-1 px-2 pb-2 pt-1">
                        <Link
                          href={subHref}
                          className="line-clamp-2 min-h-[1.75rem] text-[13px] font-black leading-tight text-slate-900 sm:text-[14px]"
                        >
                          {sub.name}
                        </Link>
                      </div>
                    ...
                    <Link
                      href={subHref}
                      className="mt-2 flex w-full items-center justify-between rounded-xl bg-red-600 px-2 py-1.5 text-left text-[9px] font-extrabold text-white transition hover:bg-red-700"
                    >
